...
export default function DashBoardElements()
{
    ...
    return(
        <div className={`flex flex-col gap-10 items-center md:px-10 md:pt-5 pb-20 md:items-start md:row-start-2 md:row-end-11 md:col-start-1 lg:col-start-3 md:col-end-12 ${darkMode?"text-[white] bg-[#020817]}":"bg-white text-black"} md:overflow-y-scroll`}>
