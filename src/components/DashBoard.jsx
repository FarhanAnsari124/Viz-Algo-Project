    ...
    return(
        ...
        >
            ...
            <div className="flex justify-center items-center h-[72.95px] w-full">
                <h1 className="text-3xl font-bold">VizAlgo</h1>
            </div>
        ...
        <div className={`flex flex-col gap-10 p-5 sm:px-18 md:px-0 md:grid md:grid-cols-[130px_130px_repeat(9,1fr)]  md:grid-rows-10 md:grid-flow-col md:h-[100vh] md:gap-0 md:p-0 ${darkMode?"bg-[#020817] text-[#e0e0e0]":"bg-white text-black"}`} onClick={()=>{setIsNavBarOpen(false)}}>
            <div className={`m-3 rounded-2xl hidden lg:flex md:col-start-3 md:col-end-12 md:row-start-1 md:row-end-2 ${darkMode?"bg-[#33333365]":"bg-[#d6d2d265]"}`}>
            ...
            <div className={`hidden lg:flex md:col-start-1 md:col-end-3 md:row-start-1 md:row-end-11 overflow-y-auto rounded-r-3xl ${darkMode?"bg-[#33333365]":"bg-[#467cf0]"}`}>
