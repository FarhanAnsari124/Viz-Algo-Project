...
export default function Header({ navBarControls, isAbout }) {
    ...
    return (
        <>
            {/* Desktop Navbar */}
            <div className={`${darkMode ? "bg-[#020b1e] shadow-[#25252665]" : "bg-[#739aee]"} shadow-xl hidden h-20 items-center gap-9 fixed w-full top-0 z-30 lg:flex`}>
                <h1 className="text-4xl font-bold ml-20 mr-auto">VizAlgo</h1>
            ...
            {/* Mobile Navbar */}
            <div className={`${darkMode ? "bg-[#020b1e] shadow-[#23232365]": "bg-[#739aee]"} flex h-20 items-center shadow-xl gap-10 fixed w-[100%] top-0 z-20 lg:hidden`}>
                <h1 className="text-4xl font-bold ml-5 sm:ml-10 mr-auto">VizAlgo</h1>
